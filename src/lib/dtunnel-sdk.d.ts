...
declare class DTunnelBridgeError extends Error {
  ...
  constructor(code: string, message: string, details?: DTunnelBridgeErrorDetails);
}
...
type DTunnelSemanticEventEnvelope<E extends DTunnelSemanticEventName> = DTunnelNativeEventEnvelope<
...
declare class DTunnelSDK {
  ...
  off(eventName: 'nativeEvent', listener: (event: DTunnelAnySemanticEventEnvelope) => void): void;
  off(
    eventName: `native:${string}`,
    listener: (event: DTunnelAnySemanticEventEnvelope) => void,
  ): void;
