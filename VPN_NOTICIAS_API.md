...
Nota: la app acepta una URL alternativa vía variable de entorno `VITE_NEWS_API_URL` (o pasando `apiUrl` a `useNoticias`) — útil para pruebas con el servidor demo `http://149.50.148.6:4001/api/noticias/vpn`.
