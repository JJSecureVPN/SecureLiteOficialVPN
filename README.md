...
- **CSS (global por archivos)** - Estilos organizados por componentes/pantallas
...
```
src/
├── app/                # Entrypoint y wiring global (providers, estilos)
├── pages/              # Pantallas (Home, Servers, Menu, Logs, Terms, Account)
├── features/           # Features por dominio (vpn, logs, etc.)
│   ├── vpn/            # Bridge nativo + estado/hook/context de VPN
│   └── logs/           # Estado/hook de logs
├── shared/             # Reutilizables (UI, componentes, hooks, tipos)
├── styles/             # Estilos CSS
